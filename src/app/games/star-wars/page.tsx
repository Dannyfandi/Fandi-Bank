...
export default async function StarWarsGamePage() {
  ...
  return (
    <div className="min-h-screen bg-[#05070E] text-zinc-100 p-3 sm:p-6 md:p-8 font-sans pb-24 relative overflow-hidden">
      ...
      <div className="max-w-5xl mx-auto space-y-6 relative z-10">
        ...
        <div className="flex items-center justify-between p-3.5 rounded-2xl glass-panel border border-cyan-500/30">
          ...
          <div className="flex items-center gap-2">
            <span className="text-[10px] uppercase font-black tracking-widest text-cyan-300 bg-cyan-500/20 border border-cyan-500/30 px-2.5 py-0.5 rounded-full flex items-center gap-1">
              <Zap className="w-3 h-3 text-cyan-400" /> Star Wars Galactic Arena
            </span>
          </div>
        </div>
